...
COMMAND="/home/tony/dev/psu-dev/instagram_scraping/start.sh  scrap-followings  --hobbies CHRISTIAN  --cookies "

# Générer le nom du fichier de log avec la date et l'heure actuelles
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="/home/tony/Dropbox/Notes/data/instagram_scraping/logs/daily/scrap_followings_${TIMESTAMP}.log"
